    ...
    <div class="container-inner has-fixed-bottom bg-white" :style="{'min-height': $store.getters.globals.height - 100 + 'px'}">
      <el-form class="px2"
        ...
        <el-form-item label="指标体系"
          ...
          <div class="mt2">
            <!--<fd-menu-table-index v-bind:menus="menus"-->
        ...
        <!--<el-form-item label="指标计算规则" prop="ruleType">-->
          <!--<el-radio v-for="item of ruleTypes" v-model="regulation.ruleType" :key = "item.id" :label="item.id">{{item.text}}</el-radio>-->
        <!--</el-form-item>-->
        <!--<el-form-item label="" prop="formula" v-show="regulation.ruleType === 'k10030-02'">-->
          <!--<el-input v-model="regulation.formula"></el-input>-->
          <!--<fd-formula-des-depart :des="des" :example="[]" ></fd-formula-des-depart>-->
        <!--</el-form-item>-->
      </el-form>
    ...
    >
      <div slot="fd-body">
        <div class="px1">
          ...
          <el-row>
            <fd-target-depart ref="target"
                       v-bind:menus="indexData"
                       v-bind:getMenus="getMenus"
                       v-on:refreshMenus="refreshMenus"></fd-target-depart>
          </el-row>
        </div>
      </div>
      <div slot="fd-footer">
...
<script>
  import regulationTableDepart from '../components/regulationTableDepart.vue'
  import FdTargetDepart from '../components/FdTargetDepart.vue'
  ...
  export default {
    ...
    components: { FdTargetDepart, regulationTableDepart, FdFormulaDesDepart, fdDialog },
    props: {},
    data() {
