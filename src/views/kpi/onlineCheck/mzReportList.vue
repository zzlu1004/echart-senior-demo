        ...
        <div>
          ...
          <el-row class="mb1">
            <el-col :span="8">
              ...
              <div class="hidden text-indent0">{{totalNum || '--'}}人</div>
            </el-col>
            <el-col :span="8">
...
<script>
  ...
  import { getRuleDetailById, refreshTableData, saveDraft, withdrawAll, resetAll, fillTable,
    saveSubmit, getTragetData, previousRule, nextRule, getAllRuleIds,
    inputTableDetail, onProgress } from '@/api/kpi/onlineCheck/mzReportList'
  ...
  export default {
    ...
    methods: {
      seeRegularDetail, saveDraft, withdrawAll, resetAll, saveSubmit, inputTableDetail, getAllRuleIds,
