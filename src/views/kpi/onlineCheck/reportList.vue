...
<script>
    ...
    import { seeRegularDetail, seeAttachment, recallTarget, revocationAll,
      ...
      refreshData, refreshAttach, getPeopleList, getTargetByUrlId, getPeopleListToTab, getRedDanger, fillTable,
      getUnfillIndexCnt } from '@/api/kpi/onlineCheck/reportList'
    ...
    export default {
      ...
      computed: {
        elements() {
          return this.$store.getters.elements.reportList || {}
        }
      },
      mounted() {
