    ...
    <div class="bg-white container-inner has-fixed-bottom clearfix h14 check-list" :style="{'min-height':height}">
      <div class="bd-dashed-bottom mb2">
        <div class="clearfix mb2 height-title">
          <div class="f-left color-title bold h20" v-if="type==='people'">{{detailRule.staffName}}</div>
      ...
      <div class="fixed-bottom">
        <div class="pt2">
          ...
          <el-button v-if="isnext && edit" size="small" class="btn-space"  type="primary" @click="saveSubmit">提交</el-button>
...
<script>
  ...
  import { seeRegularDetail, seeAttachment, recallTarget,
    ...
    refreshData, getPeopleList, getTargetByUrlId, getPeopleListToTab, getRedDanger, fillTable } from '@/api/kpi/onlineCheck/checkList'
  ...
  export default {
    ...
    computed: {
      elements() {
        return this.$store.getters.elements.checkList || {}
      }
    },
    mounted() {
