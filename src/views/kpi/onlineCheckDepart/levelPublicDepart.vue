        ...
        >
          <div slot="fd-body">
            <el-form>
              ...
              <div class="color-forbid" v-html="content">
              </div>
            </el-form>
          </div>
          <div slot="fd-footer">
...
<script>
    ...
    import { changeIndexModels, editPublic, publicing, callPublic, publicingActive, callPublicActive,
      ...
      , activeSizeChange, gotoDetail, surePublic } from '@/api/kpi/onlineCheckDepart/levelPublicDepart'
    export default {
          ...
          levelOption: {
            ...
            columns: [
              ...
              },
              {
                ...
                title: '评档进度 ',
                formatter: (row, value) => {
                  return row.markCount + '/' + row.departCount
                }
              },
              {
                field: 'isPublic',
