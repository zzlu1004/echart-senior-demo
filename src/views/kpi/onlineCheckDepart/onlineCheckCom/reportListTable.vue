        ...
        <div slot="fd-body">
          <el-form
            ...
            <div class="over-box pr2">
              <el-row
                v-if="attachForm.fillNodeActions.length === 0" :gutter="32">
              ...
              <el-row
                v-else
                v-for="(it, index) of attachForm.fillNodeActions" :key="it.id" :gutter="32">
                <el-col :span="12" class="special-item">
                  <el-form-item label="填报人">
...
import { seeRegularDetail, saveDraft, saveSubmit, seeAttachment, recallTarget,
  ...
  downloadFile, checkFillScore, beforeAvatarUpload, inputFile, inputFilter, addAttachBtn } from '@/api/kpi/onlineCheckDepart/reportListDepart'
