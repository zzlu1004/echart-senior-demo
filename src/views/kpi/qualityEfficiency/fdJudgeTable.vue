<template>
  <div>
    <div class="clearfix mb3 fd-judge-table">
     <div class="clearfix pb2 table-search">
          ...
          <span class="f-right mr3">
            <fd-search v-if="elements.judge && type === 'judge'" @search="searchByKeyword"
...
<script>
  ...
  import { searchByKeyword, countPeg, changeCols, downloadTable, getColumns, refreshCondition,
    getJudgeTotal, currentChange, sizeChange, sortByNum2, getWidth } from '@/api/kpi/qualityEfficiency/workQuality'
  export default {
    name: 'fdJudgeTable',
    components: {
    ...
    methods: {
      ...
      getJudgeTotal, currentChange, sizeChange, sortByNum2, getWidth
    },
    watch: {
      isFlag() {
        this.params = this.fd.tools.merge(true, {}, this.params, this.Pparams)
