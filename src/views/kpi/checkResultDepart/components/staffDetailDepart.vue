  ...
  <div class="app-container moral">
    <div class="container-inner has-fixed-bottom bg-white" :style="{'min-height': $store.getters.globals.height - 100 + 'px'}">
      <div class="bd clearfix p3 full-div relative">
        ...
        <span class="absolute name-box h28 color-title bold multiple2-hidden" v-bind:title="userInfo.departName">
          {{userInfo.departName}}
        </span>
...
<script>
  ...
  import { getTargetList, downloadMyResult, emitParentType } from '@/api/kpi/checkResultDepart/myResultDepart'
