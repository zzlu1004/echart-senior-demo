    ...
    >
      <div slot="fd-body">
        <div>
          ...
          <fd-mz-target  ref="target"
                         v-if="type === 'personal'"
                         :type="type"
                      v-bind:menus="indexData"
                      v-bind:getMenus="getMenus"
                      v-on:refreshMenus="refreshMenus"></fd-mz-target>
        </div>
      </div>
      <div slot="fd-footer">
...
<script>
  import mzRegulationTable from '../components/mzRegulationTable.vue'
  import FdMzTarget from '../components/FdMzTarget.vue'
  ...
  export default {
    ...
    components: { FdMzTarget, mzRegulationTable, FdFormulaDes, fdDialog },
    props: {},
    data() {
