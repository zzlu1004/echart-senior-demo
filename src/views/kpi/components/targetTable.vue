...
<script>
let exist = {}
import { showPeg, stafftargetPeg } from '@/api/kpi/checkResult/myResult'
import { casePeg, cbrWorkPeg, moralPeg, getPegValue, mzIndexPeg } from '@/api/kpi/checkResult/tableDetail'
export default {
  name: 'targetTable',
  beforeUpdate() {
    exist = {}
  ...
  methods: {
    showPeg, casePeg, cbrWorkPeg, moralPeg, getPegValue, stafftargetPeg, mzIndexPeg,
    getExist(parent) {
    ...
    // 将指标目录和指标信息整合
    getRegulationData(menus = this.menus, targetMap = this.targetMap, menuId = 'id', listId = 'staffId') {
