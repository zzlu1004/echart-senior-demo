...
import { countPeg, currentChange, sizeChange, searchByKeyword, downloadTable, refreshCondition,
  getMonthTotal, getYearTotal, refreshJudgeAll, changeCols, getColumns, getWeightOpt,
...
export default {
  ...
  methods: {
    ...
    getYearTotal, refreshJudgeAll, getColumns, changeCols, getWeightOpt, sortByNum
  },
  watch: {
    active(val, oldVal) {
      if (val) {
