<template>
  <div class="target-drag-list px1">
    <el-row :gutter="16">
      ...
      <el-col :span="13">
        <div class="p1 bd-dashed relative target-ku">
          ...
          <div>
            <el-radio-group v-model="indexType" @change="getTargetList" size="small">
              ...
              <el-radio-button label="newSystem" border>新系统测算({{newSystemAccessCnt}})</el-radio-button>
              <!--<el-radio-button label="marked" border>标记指标({{markedCnt}})</el-radio-button>-->
            </el-radio-group>
          </div>
...
<script>
  import {
    getTargetList,
    showTarget
  } from '@/api/kpi/checkDepart/addRegulationDepart'
  import {
    getTargetCount
