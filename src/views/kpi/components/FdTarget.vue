<template>
  <div class="target-drag-list">
    <el-row>
      <el-col :span="11">
        <div id = "targetLeftMenu" name="toMenuList" class="p1 bd bg auto radius-normal" style="height: 24rem;">
          ...
          <div class="p1 bd-dashed relative target-ku radius-normal">
            ...
            <div>
              <el-radio-group v-model="indexType" @change="getTargetList" size="small">
                ...
                <!--<el-radio-button label="system" border>旧系统测算({{systemCnt}})</el-radio-button>-->
              </el-radio-group>
            </div>
...
<script>
  import {
    getTargetList,
    showTarget
  } from '@/api/kpi/check/addRegulation'
  import {
    getTargetCount
