<template>
  <div>
    <echart-table
      :echartOption="assistantCaseRateOpt"
      :tableOption="assistantCaseRateOption"
      echartHeight="305px"
      tableClassName="mt2"
      :centerHtml="assistantCenterHtml"
  ...
  export default {
    ...
    data() {
      return {
        type: 'assistant',
        assistantCenterHtml: '',
        assistantCaseRateObj: {},
        assistantCaseRateOpt: {
          data: [],
          type: 'pie',
          chartOption: {},
          chart: null,
