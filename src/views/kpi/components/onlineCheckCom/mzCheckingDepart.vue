...
<script>
  ...
  import kpiCardDepart from '../kpiCardDepart'
  import FdNoContent from 'fd/noContent'
  import FdPagination from 'fd/pagination/pagination'
  import { searchByKeyword, getxzList,
    fillXz, gotoDetailByName, seeRuleDetail } from '@/api/kpi/onlineCheckDepart/mzReportingDepart'
  export default {
    name: 'mzCheckingDepart',
    components: {
      fdTable, kpiCardDepart, FdPagination, FdNoContent
    },
    methods: {
      searchByKeyword,
