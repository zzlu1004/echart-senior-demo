...
<script>
  ...
  import { statusName, statusColor } from '@/api/kpi/check/regulation'
  import { goBack } from '@/api/common'
  import FdTable from 'fd/table/src/fdTable'
  export default {
    name: 'regulationDetail',
    components: { FdTable, regulationTable, FdFormulaDes },
    props: {},
    data() {
      return {
        target: {
    ...
    computed: {
      ...
      elements() {
        return this.$store.getters.elements.regulations || {}
      }
    },
    mounted() {
    },
