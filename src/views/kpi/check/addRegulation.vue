    ...
    >
      <div slot="fd-body">
        <div>
          ...
          <fd-target  ref="target"
                      v-bind:menus="indexData"
                      v-bind:getMenus="getMenus"
                      v-on:refreshMenus="refreshMenus"></fd-target>
        </div>
      </div>
      <div slot="fd-footer">
...
<script>
  ...
  import FdTarget from '../components/FdTarget.vue'
  ...
  import {
    ...
    getRegulationIndexs,
    getRegulationDetail
  } from '@/api/kpi/check/regulation'
  export default {
    name: '',
    components: { FdTarget, regulationTable, FdFormulaDes, fdDialog },
    props: {},
    data() {
