    ...
    <div class="bg-white container-inner clearfix h14 target" :style="{'min-height': height - 100 + 'px'}">
      <div class="tab-box tab-box-mar">
        <el-tabs v-model="params.indexType" type="card" v-if="elements.report || elements.newSystem" @tab-click="handleClick">
          ...
          <el-tab-pane v-if="elements.newSystem" :label="'系统测算('+newSystemCnt+')'" name="newSystem">
            <!-- 新系统测算 -->
          ...
          <!--<el-tab-pane v-if="elements.system" :label="'旧系统测算('+systemCnt+')'" name="system">-->
            <!--<div v-show="params.indexType ==='system'">-->
              <!--<div class="clearfix py2">-->
                <!--<div class="f-left">-->
                  <!--<span class="btn btn-primary btn-sm" @click="orderTargetType({data:{id:'system', name: '所有指标类别'}, children: pOrderOpt})">-->
                      <!--排序-->
                  <!--</span>-->
                <!--</div>-->
                <!--<div class="f-right">-->
                  <!--<fd-search v-if="params.indexType ==='system'" @search="searchByKeyword"-->
              ...
              <!--<div>-->
                <!--<div class="mb2">-->
                  <!--<fd-tree-table-->
                    ...
                    <!--:columns="systemOption.columns"-->
                    <!--:height="systemOption.height"-->
                    <!--:data="systemTargetData"-->
                ...
                <el-form
                  ...
                  <div class="tab-box" style="padding-left: 35%">
                    <el-radio-group v-model="newSystemRadio" size="small">
                      ...
                      <el-radio-button label="personal">个人指标值</el-radio-button>
                  ...
                  <div class="clearfix py2">
                    <div v-if="targetForm.indexLevel!== 'k10032-02'">
                      <el-form-item label="个人指标值范围" prop="personalScope">
                        <el-input :readonly="modelTitle == '指标详情'" v-model="targetForm.personalScope" placeholder="请输入个人指标值范围"></el-input>
                      </el-form-item>
                    ...
                    <div class="no-personal center" v-else>
                      因【基础值】页面「指标层级」选择为“二级”。所以此页面不需要填写
                    </div>
                  </div>
                </div>
                <div v-show="newSystemRadio === 'scoreChange'">
                  <div class="clearfix py2">
                      <el-form-item label="部门值规则" prop="departExpression">
                        <el-select :disabled="modelTitle == '指标详情'" v-model="targetForm.departExpression" placeholder="请选择部门值规则">
                          <el-option
                      ...
                      <el-form-item v-if="!(targetForm.indexLevel=== 'k10032-02' && targetForm.departExpression === 'k10034-01')" label="部门值范围" prop="departScope">
                        <el-input :readonly="modelTitle == '指标详情'" type="textarea" v-model="targetForm.departScope" placeholder="请输入部门值范围"></el-input>
                      </el-form-item>
                      <el-form-item label="部门均值分子规则" prop="departAvgNumeratorExpression">
                        <el-select :disabled="modelTitle == '指标详情'" v-model="targetForm.departAvgNumeratorExpression" placeholder="请选择部门均值分子规则">
                          <el-option
                            v-for="item in departExpressions"
                            :key="item.id"
                            :label="item.name"
                      ...
                      <el-form-item  v-if="!(targetForm.indexLevel=== 'k10032-02' && targetForm.departAvgNumeratorExpression === 'k10034-01')" label="部门均值分子范围" prop="departAvgNumeratorScope">
                        <el-input :readonly="modelTitle == '指标详情'" type="textarea" v-model="targetForm.departAvgNumeratorScope" placeholder="请输入部门均值分子范围"></el-input>
                      </el-form-item>
                      <el-form-item label="部门均值分母规则" prop="departAvgDenominatorExpression">
                        <el-input :readonly="modelTitle == '指标详情'" type="textarea" v-model="targetForm.departAvgDenominatorExpression" placeholder="请输入部门均值分母规则"></el-input>
                      </el-form-item>
                      <el-form-item label="部门均值分母范围" prop="departAvgDenominatorScope">
                        <el-input :readonly="modelTitle == '指标详情'" type="textarea" v-model="targetForm.departAvgDenominatorScope" placeholder="请输入部门均值分母范围"></el-input>
                      </el-form-item>
...
<script>
    ...
    import { currentChange, sizeChange } from '@/api/kpi/check/checkProcess'
    ...
    import { addTargetType, orderTargetType, getTargetList, sureSave, addTarget, orderTarget,
      ...
      searchByKeyword, saveSort, seeTarget, downloadTable } from '@/api/kpi/check/target'
    ...
    export default {
      ...
      mounted() {
        if (this.elements.report) {
          this.params.indexType = 'report'
        } else if (this.elements.newSystem) {
          this.params.indexType = 'newSystem'
        } else if (this.elements.system) {
