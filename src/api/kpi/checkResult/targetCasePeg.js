...
export function refreshAllResult() {
  ...
  if (this.type === 'case') {
    ...
    if (this.kpiType === 'k10033-01' || this.kpiType === 'k10033-03' || this.kpiType === 'k10033-04' || this.kpiType === 'k10033-05' || this.kpiType === 'k10033-06' || this.kpiType === 'k10033-07') {
      url = 'api/assessmet/result/index/kpi/' + this.indexId + '/detail'
    } else {
      url = 'api/assessmet/result/index/kpi/' + this.indexId
    }
    ...
    if (this.kpiType === 'k10033-02') {
      ...
      url = 'api/assessmet/result/index/kpi/workload/' + this.indexId
    }
  }
  this.fd.req({
    url: url,
...
export function downloadTable() {
  ...
  if (this.type === 'case') {
    // k10033-01：案件数反查接口 k10033-03：审理时间指数反查接口 k10033-04：后审指标反查接口 k10033-05: 文书上网数反查k10033-06:庭审直播数反查 k10033-07:开庭排期数反查
    if (this.kpiType === 'k10033-01' || this.kpiType === 'k10033-03' || this.kpiType === 'k10033-04' || this.kpiType === 'k10033-05' || this.kpiType === 'k10033-06' || this.kpiType === 'k10033-07') {
      url = 'api/assessmet/result/index/kpi/' + this.indexId + '/detail/download'
    } else {
      url = 'api/assessmet/result/index/kpi/' + this.indexId + '/download'
    }
  } else if (this.type === 'workload') {
    // k10033-02：案件工作量反查接口
    if (this.kpiType === 'k10033-02') {
      ...
      url = 'api/assessmet/result/index/kpi/workload/' + this.indexId + '/download'
    }
  }
