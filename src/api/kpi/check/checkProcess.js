...
export function addProcess() {
  this.fd.tools.goDetail.call(this, 'processDetail', { query: { page: 'add' }})
}
export function editProcess(row) {
  this.fd.tools.goDetail.call(this, 'processDetail', { query: { page: 'edit', id: row.id }})
}
...
export function gotoDetail(row, column, cell, event) {
  if (column.property === 'name') {
    this.fd.tools.goDetail.call(this, 'processDetail', { query: { id: row.id, page: 'detail' }})
  }
}
